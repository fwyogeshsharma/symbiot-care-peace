...
-- Insert fake movement data for user yogesh.sharma@faberwork.com (elderly_person_id: c7b04375-03f9-42d0-bc82-380bba7dbcd6)
-- Creating a realistic daily movement pattern

-- Morning routine (6:00 AM - 9:00 AM)
INSERT INTO device_data (elderly_person_id, device_id, data_type, value, recorded_at) VALUES
-- Wake up in bedroom at 6:15 AM
