                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-2 mb-1 w-full min-w-0">
                          ...
                          <span className="text-sm font-medium whitespace-normal break-words leading-tight">{link.title}</span>
                        </div>
                        <span className="text-xs text-muted-foreground whitespace-normal break-words w-full leading-tight">
                          {link.description}
                        </span>
                      </Button>
                    );
